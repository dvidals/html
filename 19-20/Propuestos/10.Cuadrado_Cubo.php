...
for ($l = 0; $l < count($a); $l++) {
    ...
    if (($a[$l] >= 10 and $a[$l]<100) and  $b[$l] <10) echo $a[$l] . "__________" . "000" . $b[$l] . "____________" . $c[$l] . "<br>";
    if (($a[$l] >= 10 and $a[$l]<100)and ($b[$l]>=10 and $b[$l]<100)) echo $a[$l] . "__________" . "00" . $b[$l] . "____________" . $c[$l] . "<br>";
