...
$fot=$_POST['fot'];
  ...
  $sql="update productos set CodProd=:miCodProd, Nombre=:miNom, Descripcion=:miDes, Peso=:miPes, Stock=:miSto,CodCat=:miCod, Foto=:miFot where CodProd=:miCodProd";
  $resultado=$bd->prepare($sql);
  $resultado->execute(array(":miCodProd"=>$CodProd, ":miNom"=>$nom, ":miDes"=>$des,":miPes"=>$pes, ":miSto"=>$sto, ":miCod"=>$cod, ":miFot"=>$fot));
...
<!-- La información da actulización tiene que enviarse a la propia página en la que estamos-->
  <table width="25%" border="0" align="center">
	...
	<tr>
      ...
      <input type="text" name="fot" id="cod" value="<?php echo $fot?>"></td>
    </tr>
    <tr>
