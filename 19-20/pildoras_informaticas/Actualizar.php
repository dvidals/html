...
<?php
 ...
 $consulta="update tabla set Dorsal=$dorsal, Nombre='$nombre', Apellidos='$apellidos', Federado='$federado', Licencia='$licencia', Categoria_Prueba='$categoria', 
 Sexo='$sexo', FechaNac='$fechanac', Club='$club', Equipo='$equipo' where Dorsal=$dorsal"; 
