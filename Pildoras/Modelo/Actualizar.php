...
class Actualizar{
    ...
    $sql = "update  cuadro set  CodCuadro=:codi, NCuadro=:cua, Alto=:alt, Ancho=:anc, Fcuadro=:fec, Tecnica=:tec, NPintor=:pint,
     NPinacoteca=:pina, numsala=:sala, NumerodeCopias=:numero where CodCuadro=$codi";
    ...
    <table width='30%' border='0' align='center'>
        ...
        <tr><td class='primera_fila'>Nº Copias</td><td><input type='text' name='numero' id='numero' value="<?php echo $numero ?>" class='act'></td></tr>
