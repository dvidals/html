...
class Cronometro {
    ...
    function __destruct() {
        ...
        $tiempo_total = round((/*(double)*/ $muerte - /*(double)*/ $this->nacimiento), 9); //el double es redundante, dame_instante ya devuelve valores reales.
    ...
    private function dame_instante() {
        ...
        // y mseg es el número de microsegundos que han transcurrido desde sec, expresado en segundos. 
