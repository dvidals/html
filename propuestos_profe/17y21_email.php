...
function checkEmail($cadena)
{
    ...
    $div2 = explode(".", $div1[1]);
    //$last = array_pop($div2);  Yo:  No entiendo para que vale en la solución del profe
   //$div2 = array(implode(".", $div2), $last); Yo: tampoco entiendo para que vale, por eso comenté las 2.
