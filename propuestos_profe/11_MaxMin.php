   ...
   /* function printArrayWithMinMaxManual($array)
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        try {
            ...
            echo ("ERROR: No hay al menos 4 valores en las cajas");
        } catch (NotNumberException $e) {
            echo ("ERROR: No puede introducir valores no numéricos");
        }
        ...
        try {
            ...
            echo ("ERROR: No hay al menos 4 valores en la segunda caja");
        } catch (NotNumberException $e) {
            echo ("ERROR: No puede introducir valores no numéricos");
        }
    }
