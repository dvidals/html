...
<div class="panel panel-primary"> 
  ...
  <div class="alert alert-danger hide" role="alert">Todos los campos tienen que contener algún dato</div>
    <label for="id"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span>Id</label>
    <input type="text" class="form-control" readonly="readonly" id="inputid" name="passwd" placeholder="Id">
  </div>
  <div class="form-group">
    <label for="alumno"><span aria-hidden="true"></span>Id Alumno</label>
    <input type="text" class="form-control" id="inputalumno" name="alumno" placeholder="Id Alumno">
  </div>
  <div class="form-group">
    <label for="nombre"><span aria-hidden="true"></span>Alumno</label>
    <input type="text" class="form-control" readonly="readonly"id="inputnombreal" name="nombreal" placeholder="Nombre">
  </div>
  <div class="form-group">
    <label for="docente"><span ></span>Id Docente</label>
    <input type="text" class="form-control" id="inputdocente" name="docente" placeholder="Id Docente">
  </div>
  <div class="form-group">
    <label for="nombre"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>Docente</label>
    <input type="text" class="form-control" readonly="readonly"id="inputnombretu" name="nombretu" placeholder="Nombre">
  </div>
  <div class="form-group">
   ...
   <div class="form-group">
    <label for="fin"><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span>Fin</label>
    <input type="text" class="form-control" id="inputfin" name="fin" placeholder="Fin">
  </div>
   <div class="form-group">
    <label for="horas"><span aria-hidden="true"></span>Horas</label>
    <input type="text" class="form-control" id="inputhoras" name="horas" placeholder="Horas">
  </div>
   <div class="form-group">
    <label for="empresa"><span aria-hidden="true"></span>Id Empresa</label>
    <input type="text" class="form-control" id="inputempresa" name="empresa" placeholder="Id Empresa">
  </div>
  <div class="form-group">
    <label for="razon_social"><span aria-hidden="true"></span>Razón_Social</label>
...
<table id="example" class="table table-hover table-striped table-bordered table-condensed" id="mitabla" width="100%" cellspacing="0">
    ...
    <script src="js/buenofct.js"></script>
</html>
