  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="panel-controlaa.php">Alumnos</a></li>
            <li><a href="panel-controlpp.php">Profesores</a></li>
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="panel-controlfct.php">FCT</a></li>            
          </ul>
      <ul class="nav navbar-nav navbar-right">
        <li><a href="panel-controlee.php">Empresas</a></li>            
          </ul>
        </li>
      </ul>
    </div><!-- /.navbar-collapse -->
