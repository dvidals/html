...
$('#example tbody').on('click','.editar', function(){
    ...
    $('#inputnombre').val(mitabla.cell(fila,2).data()).prop("disable", false);
    $('#inputdocente').val(mitabla.cell(fila,3).data()).prop("disable", false);
    $('#inputnombret').val(mitabla.cell(fila,4).data()).prop("disable", false); 
    ...
    $('#inputempresa').val(mitabla.cell(fila,8).data()).prop("disable", false);
  ...
  var engU=function(){
   ...
   // $('#inputdocente').prop("disable", false).val($("idprofe").val());
    //$('#inputnombret').prop("disable", false).val($("nombreprofe").val()); 
    $('#inputdocente').val(mitabla.cell(fila,3).data()).prop("disable", false);
    $('#inputnombret').val(mitabla.cell(fila,4).data()).prop("disable", false); 
