...
function control(){
  ...
  $('#inputbaja').removeClass('error');
  $('#inputactivo').removeClass('error');
  $('#inputdatos').removeClass('error');
  ...
  //if($('#inputbaja').val()==""||$('#inputbaja').val()==" "){
  //$('#inputbaja').addClass('error');
  //valido=false;
  //}
...
$('#example tbody').on('click','.eliminar', function(){
    ...
    $('#inputbaja').val(mitabla.cell(fila,5).data()).prop("disable", true);
