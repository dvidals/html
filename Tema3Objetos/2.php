 ...
 class Persoa extends DateTime{
    ...
    */
    ...
    public function verInformación(){
        echo "$this->nome  ten ".self::diasVivo($date1)."<br/> O seu sexo é: $this->sexo"; //da igual que se ponga $nacemento en este punto
    }
*/

function diasVivo($d1) {
    ...
    if ($df->y > 0) {
        // anos
        $str .= ($df->y > 1) ? $df->y . 'ten  anos ' : $df->y . ' año ';
    } if ($df->m > 0) {
        // meses
...
$persoa1=new Persoa("David",1977-05-11,'H');

//$diff = $date1->diff($date2);
 Persoa::diasVivo($date1);echo"<br/>";
